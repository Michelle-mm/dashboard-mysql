...
export const Notification = () => {
  ...
  return (
    <div className="nav-item absolute right-5 border-1 md:right-40 top-16 bg-white/30 backdrop-blur-md dark:bg-[#42464D] p-8 rounded-lg w-96"
    style={{borderColor: currentColor}}>
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          <p className="font-semibold text-2xl dark:text-gray-200" style={{color: currentColor}}>Notifications</p>
